...
bool ImGui::CloseButton(ImGuiID id, const ImVec2& pos, float radius)
{
	...
	const ImRect bb(pos - ImVec2(radius, radius - 1), pos + ImVec2(radius - 1, radius));
	...
	RenderFrame(bb.Min + ImVec2(ImGui::GetStyle().WindowPadThickness,0), bb.Max + ImVec2(ImGui::GetStyle().WindowPadThickness, 0), col, true, window_rounding);
