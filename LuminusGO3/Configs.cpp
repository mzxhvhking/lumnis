...
void ConfigManager::SetupConfigs()
{
	...
	DeclareConfig(&cfg.Aimbot.onlyX, true, xorstr("cfg.Aimbot.onlyX"), xorstr("Aimbot"));
	...
	DeclareConfig(&cfg.Rage.AntiAim.untrusted, false, xorstr("cfg.Rage.AntiAim.untrusted"), xorstr("Rage"));
	...
	DeclareConfig(&cfg.Rage.AutoFire.inGround, true, xorstr("cfg.Rage.AutoFire.inGround"), xorstr("Rage"));
	...
	DeclareConfig(&cfg.Rage.AutoFire.multiPoint, true, xorstr("cfg.Rage.AutoFire.multiPoint"), xorstr("Aimbot"));
	...
	DeclareConfig(&cfg.Visual.enabled, true, xorstr("cfg.Visual.enabled"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.dinamicFOV, true, xorstr("cfg.Visual.dinamicFOV"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.drawFOV, true, xorstr("cfg.Visual.drawFOV"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.drawCrosshair, true, xorstr("cfg.Visual.drawCrosshair"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.drawTracers, false, xorstr("cfg.Visual.drawTracers"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.drawNames, true, xorstr("cfg.Visual.drawNames"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.drawWeapons, true, xorstr("cfg.Visual.drawWeapons"), xorstr("Visual"));
	...
	DeclareConfig(&cfg.Visual.drawItems, true, xorstr("cfg.Visual.drawItems"), xorstr("Visual"));
	...
	DeclareConfig(&cfg.Visual.showTeam, true, xorstr("cfg.Visual.showTeam"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.drawAmmo, true, xorstr("cfg.Visual.drawAmmo"), xorstr("Visual"));
	DeclareConfig(&cfg.Visual.hitmarkersound, true, xorstr("cfg.Visual.hitmarkersound"), xorstr("Visual"));
	...
	DeclareConfig(&cfg.Visual.granadePrediction, true, xorstr("cfg.Visual.granadePrediction"), xorstr("Visual"));
	...
	DeclareConfig(&cfg.Misc.bunnyhop, true, xorstr("cfg.Misc.bunnyhop"), xorstr("Misc"));
	...
	DeclareConfig(&cfg.Misc.buunyhopStopAtWall, true, xorstr("cfg.Misc.buunyhopStopAtWall"), xorstr("Misc"));
	...
	DeclareConfig(&cfg.SkinChanger.knife, 0, xorstr("cfg.SkinChanger.knife"), xorstr("SkinChanger"));
...
{
	std::string path = "C:\\luminusleak\\cfg\\";
